...
import com.flitzen.adityarealestate.Items.ReceivedPayment;
import com.flitzen.adityarealestate.R;
import com.flitzen.adityarealestate.pdfcreator.activity.PDFCreatorActivity;
import com.flitzen.adityarealestate.pdfcreator.utils.PDFUtil;
import com.flitzen.adityarealestate.pdfcreator.views.PDFBody;
import com.flitzen.adityarealestate.pdfcreator.views.PDFHeaderView;
import com.flitzen.adityarealestate.pdfcreator.views.PDFTableView;
import com.flitzen.adityarealestate.pdfcreator.views.basic.PDFCustomView;
import com.flitzen.adityarealestate.pdfcreator.views.basic.PDFLineSeparatorView;
import com.flitzen.adityarealestate.pdfcreator.views.basic.PDFTextView;
...
public class PdfCreatorCashReceivedActivity extends PDFCreatorActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("CashPaymentDetails") && getIntent().hasExtra("paymentList")){
            ...
            receivedPaymentList= (ArrayList<ReceivedPayment>) getIntent().getSerializableExtra("paymentList");
        }

        createPDF("test", new PDFUtil.PDFUtilListener() {
            @Override
            public void pdfGenerationSuccess(File savedPDFFile) {
                Toast.makeText(PdfCreatorCashReceivedActivity.this, "PDF Created", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void pdfGenerationFailure(Exception exception) {
                Toast.makeText(PdfCreatorCashReceivedActivity.this, "PDF NOT Created", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected PDFBody getBodyViews() {
        ...
        PDFCustomView pdfCustomView=new PDFCustomView(PdfCreatorCashReceivedActivity.this,view, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT,cashPaymentDetailsForPDF);
       ...
       /* for (String s : textInTable) {
        ...
        for (int i = 0; i < receivedPaymentList.size(); i++) {
            ...
            for(int j=0;j<4;j++){
                ...
                if(j==0){
                    ...
                    receivedPaymentList.get(i).getPayment_time();
                    ...
                    pdfTextView.setText(receivedPaymentList.get(i).getRemarks());
                    tableRowView.addToRow(pdfTextView);
                }
                else if(j==2){
                    PDFTextView pdfTextViewR = new PDFTextView(getApplicationContext(), PDFTextView.PDF_TEXT_SIZE.P,0);
                    pdfTextViewR.setText(Helper.getFormatPrice(Integer.parseInt(receivedPaymentList.get(i).getAmount())));
                    finalTotalAmount=finalTotalAmount+Integer.parseInt(receivedPaymentList.get(i).getAmount());
        ...
        PDFCustomView pdfCustomViewFinal=new PDFCustomView(PdfCreatorCashReceivedActivity.this,viewFinal, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT,finalTotalAmount);
    ...
    protected void onNextClicked(final File savedPDFFile) {
        ...
        Intent intentPdfViewer = new Intent(PdfCreatorCashReceivedActivity.this, PdfViewerActivity.class);
