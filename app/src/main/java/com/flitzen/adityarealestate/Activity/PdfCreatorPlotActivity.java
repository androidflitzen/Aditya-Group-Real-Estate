...
public class PdfCreatorPlotActivity extends PDFCreatorActivity {


    PlotDetailsForPDF plotDetailsForPDF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("SiteDetails") && getIntent().hasExtra("paymentList")){
            plotDetailsForPDF= (PlotDetailsForPDF) getIntent().getSerializableExtra("SiteDetails");
        ...
        createPDF("test", new PDFUtil.PDFUtilListener() {
            ...
            public void pdfGenerationSuccess(File savedPDFFile) {
                Toast.makeText(PdfCreatorPlotActivity.this, "PDF Created", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void pdfGenerationFailure(Exception exception) {
                Toast.makeText(PdfCreatorPlotActivity.this, "PDF NOT Created", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected PDFBody getBodyViews() {
        ...
        pdfCompanyNameView.setText("Plot Payment List");
        ...
        PDFCustomView pdfCustomView=new PDFCustomView(PdfCreatorPlotActivity.this,view, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT,plotDetailsForPDF,arrayListPlotPayment);
       ...
       /* for (String s : textInTable) {
        ...
        PDFCustomView pdfCustomViewFinal=new PDFCustomView(PdfCreatorPlotActivity.this,viewFinal, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT,finalTotalAmount);
    ...
    protected void onNextClicked(final File savedPDFFile) {
        ...
        Intent intentPdfViewer = new Intent(PdfCreatorPlotActivity.this, PdfViewerActivity.class);
