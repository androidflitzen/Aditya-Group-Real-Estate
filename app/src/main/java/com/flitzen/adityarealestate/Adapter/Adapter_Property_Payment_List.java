...
public class Adapter_Property_Payment_List extends RecyclerView.Adapter<Adapter_Property_Payment_List.ViewHolder> {

    Context context;
    ArrayList<Item_Property_Detail.Item_Plot_Payment> itemList = new ArrayList<>();
    OnItemLongClickListener mItemClickListener;

    public Adapter_Property_Payment_List(Context context, ArrayList<Item_Property_Detail.Item_Plot_Payment> itemList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView txt_amount, txt_date, txt_time, txt_remarks;
        View view_main;
