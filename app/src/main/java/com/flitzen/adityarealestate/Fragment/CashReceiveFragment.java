...
import com.flitzen.adityarealestate.Activity.PdfCreatorCashReceivedActivity;
import com.flitzen.adityarealestate.Activity.PdfViewActivity;
import com.flitzen.adityarealestate.Adapter.ReceivedPaymentListAdapter;
...
public class CashReceiveFragment extends Fragment {
    ...
    private void initUI(View view) {
        ...
        tvViewPaymentPDF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* file_url = API.PRINT_SITE_RECEIVE_PAYMENT_URL + site_id;
                Log.w("ravi_url", file_url);
