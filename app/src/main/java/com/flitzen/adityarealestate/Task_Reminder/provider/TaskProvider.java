package com.flitzen.adityarealestate.Task_Reminder.provider;
...
public class TaskProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.flitzen.adityarealestate.Task_Reminder.provider.TaskProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/task");

    private static final String TASKS_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.sumir.reminder.tasks";
    private static final String TASK_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vmd.com.sumir.reminder.task";
