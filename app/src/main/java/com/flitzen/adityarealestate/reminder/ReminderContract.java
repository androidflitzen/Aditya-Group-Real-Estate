...
public final class ReminderContract {
  ...
  public static final String[] PROJECTION_ALL = {_ID, TYPE, TASK_ID,TITLE, CONTENT, TIME, FREQUENCY};
  ...
  public static final class Notes implements BaseColumns {
    ...
    public static final String[] PROJECTION_ALL = {_ID, TYPE, TASK_ID,TITLE, CONTENT};
  }
