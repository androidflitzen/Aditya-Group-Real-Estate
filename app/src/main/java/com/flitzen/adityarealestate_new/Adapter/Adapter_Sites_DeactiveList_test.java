...
public class Adapter_Sites_DeactiveList_test extends RecyclerView.Adapter<Adapter_Sites_DeactiveList_test.ViewHolder> {
    ...
    public Adapter_Sites_DeactiveList_test(Activity context, ArrayList<Item_Sites_List> itemList, Boolean value) {
